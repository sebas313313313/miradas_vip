            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                ...
                <div className="flex items-center gap-3">
                  {/* Facebook SVG */}
                  <a href="https://www.facebook.com/profile.php?id=61550919825948" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-white border border-lavender flex items-center justify-center hover:border-rose-gold hover:text-rose-gold transition-colors shadow-sm group">
                  ...
                  {/* Instagram SVG */}
                  <a href="https://www.instagram.com/miradasvip_oficial/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-gradient-to-tr from-yellow-400 via-rose-500 to-purple-600 p-[2px] group shadow-sm hover:shadow-md transition-all">
